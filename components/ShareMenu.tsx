...
const ShareMenu: React.FC<ShareMenuProps> = ({ isOpen, onClose, url, title, theme }) => {
  ...
  const shareOptions = [
    ...
    },
    {
      ...
      icon: (
        <img
          src={theme === 'light' ? 'https://res.cloudinary.com/dk0f2y0hu/image/upload/v1757767063/icons8-reddit-480_lswdam.png' : 'https://res.cloudinary.com/dk0f2y0hu/image/upload/v1757767063/icons8-reddit-480-2_k4ne6g.png'}
          alt="Reddit"
    ...
    <div className="modal-backdrop" onClick={onClose}>
      <div className="modal-content" onClick={(e) => e.stopPropagation()}>
        ...
        <div className="share-options">
          ...
          {navigator.share && (
            <button onClick={handleNativeShare} className="share-option native-share">
              <Share2 size={20} />
              <span>Other</span>
            </button>
          )}
